        ...
        fr: {
            ...
            knowledgeBase: [
                ...
                },
                {
                    ...
                    <br><br><a href="${routes.contact}" class="chat-link">Page Contact</a>`
                }
            ]
        },
        en: {
            ...
            knowledgeBase: [
                ...
                },
                {
                    ...
                    answer: `Our team is available 24/7 to assist you. You can contact us via the contact form or directly through WhatsApp at +216 26 341 186
                    <br><br><a href="${routes.contact}" class="chat-link">Contact Page</a>`
                }
            ]
        }
    };
